...
/**
 * OptionalArgument is a subclass of argument that handles arguments that will come in named on the command
 * line (if they are given at all) and be given a default value by the client for cases in which the user does
...
public class OptionalArgument extends Argument {
   ...
   * in the help message, and the value that will be used as its default value. The client can call getValue
   * to retrieve the stored value in the type specified when OptionalArgument is constructed.
