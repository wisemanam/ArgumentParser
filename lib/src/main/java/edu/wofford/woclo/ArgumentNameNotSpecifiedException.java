...
/**
 * The ArgumentNameNotSpecifiedException is thrown when the name of an argument given to ArgumentParser 
 * does not match an expected argument name. The exception requires the argument name given to the 
 * ArgumentParser. It includes methods that return the name of the argument that does not match an 
